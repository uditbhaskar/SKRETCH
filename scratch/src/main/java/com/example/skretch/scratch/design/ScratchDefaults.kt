package com.example.skretch.scratch.design

import androidx.compose.ui.graphics.Color
import androidx.compose.ui.unit.dp

/**
 * Default foil colors and card chrome for [com.example.skretch.scratch.component.ScratchCard].
 *
 * @author udit
 */
object ScratchDefaults {
    ...
    val foilGrain = Color(0xFFFFFFFF)
